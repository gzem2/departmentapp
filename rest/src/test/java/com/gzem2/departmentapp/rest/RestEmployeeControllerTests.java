...
public class RestEmployeeControllerTests {
        ...
        public void before() {
                ...
                emps = Arrays.asList(new Employee(1L, "surname", "name", "patronymic", LocalDate.of(1970, 1, 1), 10000),
                ...
                Mockito.when(service.findEmployeesByDepartmentId(1L))
                                .thenReturn(Arrays.asList(emps.get(0), emps.get(1), emps.get(2)));
                Mockito.when(service.findEmployeesByBirthday(LocalDate.of(1970, 1, 1)))
                                .thenReturn(Arrays.asList(emps.get(0)));
        ...
        public void testGetBornBetween() throws Exception {
                when(service.findEmployeesBornBetween(LocalDate.of(1970, 2, 1), LocalDate.of(1972, 2, 1)))
                                .thenReturn(Arrays.asList(emps.get(1), emps.get(2)));
                this.mockMvc.perform(get("/employees/bornbetween/1970-02-01/1972-02-01")).andDo(print())
                                .andExpect(status().isOk()).andExpect(content().string(containsString("surname")));
        }
        ...
        public void testGetByDepartmentId() throws Exception {
                when(service.findEmployeesByDepartmentId(1L))
                                .thenReturn(Arrays.asList(emps.get(0), emps.get(1), emps.get(2)));
        ...
        public void testGetBySurname() throws Exception {
                when(service.findEmployeesBySurname("surname")).thenReturn(emps);
        ...
        public void testGetByName() throws Exception {
                when(service.findEmployeesByName("name")).thenReturn(emps);
        ...
        public void testGetByPatronymic() throws Exception {
                when(service.findEmployeesByPatronymic("patronymic")).thenReturn(emps);
        ...
        public void testGetByFullName() throws Exception {
                when(service.findEmployeesByFullName("surname name patronymic")).thenReturn(emps);
                this.mockMvc.perform(get("/employees/fullname/surname%20name%20patronymic")).andDo(print())
                                .andExpect(status().isOk()).andExpect(content().string(containsString("surname")));
        }

        @Test
        public void testGetByBirthday() throws Exception {
                when(service.findEmployeesByBirthday(LocalDate.parse("1970-01-01"))).thenReturn(emps);
        ...
        public void testGetBySalary() throws Exception {
                when(service.findEmployeesBySalary(10000)).thenReturn(emps);
        ...
        public void testCreate() throws Exception {
                ...
                this.mockMvc.perform(post("/employees").contentType(MediaType.APPLICATION_JSON)
                                .accept(MediaType.APPLICATION_JSON).content(mapper.writeValueAsBytes(emps.get(0))))
        ...
        public void testUpdate() throws Exception {
                ...
                this.mockMvc.perform(put("/employees/1").contentType(MediaType.APPLICATION_JSON)
                                .accept(MediaType.APPLICATION_JSON).content(mapper.writeValueAsBytes(emps.get(1))))
                                .andDo(print()).andExpect(status().isOk());
        }
